...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={projectRef} className="py-20 px-4 bg-white text-gray-900">
          ...
          {projects.map((project, index) => (
            <div key={index} className="bg-gray-50 rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <a href={project.link} className="text-blue-600 mt-4 inline-block">View Project →</a>
              </div>
            </div>
          ))}
        </div>
